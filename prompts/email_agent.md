...
## Email Requirements
- Begin with a formal salutation addressing the player by name
- Clearly state the club's interest in signing them for a specific position
...
Do NOT use markdown formatting — plain text only. No bullet points, no headers, no asterisks.
